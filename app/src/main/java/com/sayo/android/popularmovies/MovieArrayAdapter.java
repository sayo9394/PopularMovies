...
public class MovieArrayAdapter extends ArrayAdapter<MovieInfo> {
     ...
     * @param movies A List of MovieInfo objects to display in a list
     */
    public MovieArrayAdapter(Activity context, List<MovieInfo> movies) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Picasso.with(getContext()).load(movieInfo.getPosterURL()).into(iconView);
